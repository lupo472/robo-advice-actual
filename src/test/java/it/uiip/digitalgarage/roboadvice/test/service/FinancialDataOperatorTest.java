...
public class FinancialDataOperatorTest {
    ...
    public void getFinancialDataSetTest() {
        ...
        when(financialDataRep.findByAssetAndDateGreaterThanOrderByDateDesc(assetEntity1, LocalDate.now().minusDays(2))).thenReturn(assetHistory1);
        when(financialDataRep.findByAssetAndDateGreaterThanOrderByDateDesc(assetEntity2, LocalDate.now().minusDays(2))).thenReturn(assetHistory2);
        List<FinancialDataDTO> response = financialDataOp.getFinancialDataSet(2);
        verify(financialDataRep).findByAssetAndDateGreaterThanOrderByDateDesc(assetEntity1, LocalDate.now().minusDays(2));
